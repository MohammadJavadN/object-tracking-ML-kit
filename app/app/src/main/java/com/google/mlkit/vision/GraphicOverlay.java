...
import com.example.vehiclespeeddetection.RoadLine;
...
//        v = Ints.constrainToRange(v, 0, 255);
  ...
  static GraphicOverlay overlay;


  public static GraphicOverlay getOverlayInstance() {
    return overlay;
  }
...
//      MainActivity.out.write(frameMat);
